...
_archive_sum="2339782280d98cf1ca698f4018709b265cd68e3ad0d9a22f48318d54a9ca15a7"
_evmfs_archive_uri="evmfs://${_evmfs_network}/${_evmfs_address}/${_evmfs_ns}/${_archive_sum}"
_evmfs_archive_src="${_tarname}.zip::${_evmfs_archive_uri}"
_archive_sig_sum="a4daa231a756eac56d289fc939be1a3709392a47833067ae59f5b3682065592b"
